   ...
   <!--/sidebar-->
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎选择『极客酷鱼』工作室。</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">北京时间</label><span class="res-info"><?php date_default_timezone_set('PRC'); echo date('Y年m月d日 H:i:s');?></span>
                    </li>
                    <li>
