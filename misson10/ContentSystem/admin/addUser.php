                        ...
                        <tbody>
	                       ...
	                       <tr>
							...
							<tr>
                                <th>是否为管理员：</th>
                                <td>
									<input class="common-text required"  id="isAdmin" name="isAdmin" size="50" value="0" type="radio" checked/>否
									<input class="common-text required"  id="isAdmin" name="isAdmin" size="50" value="2" type="radio"/>是
								</td>
                            </tr>
                            <tr>
                                <th></th>
